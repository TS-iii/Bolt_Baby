...
public class FADService extends Service implements  BeaconConsumer  {
    ...
    public void onCreate() {
        ...
        Log.d("TTTTTTT"," FAD Service ONCREATE!!!!!!!!!!!");
        super.onCreate();
        tf=1;
  ...
  //      if(PreferenceManager.getInt(this,"app")==1){
            ...
            Log.d("TTTTTTT","FAD Service App Restart!!!!");
...
public synchronized void alarm(){
    ...
    String name="";
    PreferenceManager.setInt(this,"video",1);
